...
function getRoundingInfoHtml($info, $dvs) {
    ...
    foreach ($merge_arr as $depth1 => $depth2_arr) {
        ...
        if ($depth1 === "네귀도리") {
            ...
            $attr = "class=\"_all\" selected=\"selected\"";
        }
...
function getImpressionInfoHtml($info, $dvs) {
    ...
    $html .= "            <dd>";
    $html .= "                <select id=\"{$dvs}_impression_cnt\" onchange=\"getAfterPrice.common('impression', '{$dvs}');\" class=\"impression_cnt\">";
    if ($is_one) {
    ...
    $html .= "                </select>";
    $html .= "                <select id=\"{$dvs}_impression_vh\" onchange=\"preview.impression('{$dvs}');\">";
    ...
    if (isset($two_mpcode3)) {
        ...
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_impression_two_pos1\" type=\"text\" class=\"mm {$dvs}_impression_two_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_impression_two_pos2\" type=\"text\" class=\"mm {$dvs}_impression_two_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label>";
        $html .= "            </dd>";
    }
    ...
    if (isset($three_mpcode2)) {
        ...
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_impression_three_pos1\" type=\"text\" class=\"mm {$dvs}_impression_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_impression_three_pos2\" type=\"text\" class=\"mm {$dvs}_impression_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>세 번째 선 <input id=\"{$dvs}_impression_three_pos3\" type=\"text\" class=\"mm {$dvs}_impression_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label>";
        $html .= "            </dd>";
    }
    ...
    if (isset($four_mpcode2)) {
        ...
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_impression_four_pos1\" type=\"text\" class=\"mm {$dvs}_impression_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_impression_four_pos2\" type=\"text\" class=\"mm {$dvs}_impression_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>세 번째 선 <input id=\"{$dvs}_impression_four_pos3\" type=\"text\" class=\"mm {$dvs}_impression_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label><br />";
        $html .= "                <label>네 번째 선 <input id=\"{$dvs}_impression_four_pos4\" type=\"text\" class=\"mm {$dvs}_impression_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'impression');\">mm</label>";
        $html .= "            </dd>";
    }
...
function getDotlineInfoHtml($info, $dvs) {
    ...
    $html .= "            <dd>";
    $html .= "                <select id=\"{$dvs}_dotline_cnt\" onchange=\"getAfterPrice.common('dotline', '{$dvs}');\" class=\"dotline_cnt\">";
    if ($is_one) {
        $html .= "                    <option value=\"one\" class=\"_one\">1줄</option>";
    }
    if ($is_two) {
    ...
    $html .= "                </select>";
    $html .= "                <select id=\"{$dvs}_dotline_vh\" onchange=\"preview.dotline('{$dvs}');\">";
    $html .= "                    <option value=\"V\">세로</option>";
    $html .= "                    <option value=\"H\">가로</option>";
    $html .= "                </select>";
    $html .= "            </dd>";
    ...
    if (isset($two_mpcode2)) {
        $html .= "            <dd class=\"br _two _custom\">";
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_dotline_two_pos1\" type=\"text\" class=\"mm {$dvs}_dotline_two_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_dotline_two_pos2\" type=\"text\" class=\"mm {$dvs}_dotline_two_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label>";
        $html .= "            </dd>";
    }
    ...
    if (isset($three_mpcode2)) {
        $html .= "            <dd class=\"br _three _custom\">";
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_dotline_three_pos1\" type=\"text\" class=\"mm {$dvs}_dotline_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_dotline_three_pos2\" type=\"text\" class=\"mm {$dvs}_dotline_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>세 번째 선 <input id=\"{$dvs}_dotline_three_pos3\" type=\"text\" class=\"mm {$dvs}_dotline_three_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label>";
        $html .= "            </dd>";
    }
    ...
    if (isset($four_mpcode2)) {
        $html .= "            <dd class=\"br _four _custom\">";
        $html .= "                <label>첫 번째 선 <input id=\"{$dvs}_dotline_four_pos1\" type=\"text\" class=\"mm {$dvs}_dotline_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>두 번째 선 <input id=\"{$dvs}_dotline_four_pos2\" type=\"text\" class=\"mm {$dvs}_dotline_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>세 번째 선 <input id=\"{$dvs}_dotline_four_pos3\" type=\"text\" class=\"mm {$dvs}_dotline_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label><br />";
        $html .= "                <label>네 번째 선 <input id=\"{$dvs}_dotline_four_pos4\" type=\"text\" class=\"mm {$dvs}_dotline_four_mm\" onblur=\"chkAftRestrict('{$dvs}', 'dotline');\">mm</label>";
        $html .= "            </dd>";
    }
    ...
    $html = <<<html
        <div class="option _punching">
            <dl>
                ...
                <dd>
                    <select class="_num" id="{$dvs}_punching_cnt" onchange="loadPunchingDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
    ...
    foreach ($merge_arr as $depth1 => $depth2_arr) {
        ...
        if ($flag === true) {
            ...
            foreach ($depth2_arr as $depth2 => $mpcode) {
                ...
                $depth2_option .= option($mpcode, $depth2, $attr);
            }
    ...
    $html = <<<html
        <div class="option _foldline">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_foldline_dvs" onchange="loadFoldlineDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
                    <select id="{$dvs}_foldline_val" name="{$dvs}_foldline_val" onchange="getAfterPrice.common('foldline', '{$dvs}');">
                        $depth2_option
                    </select>

                    <select id="{$dvs}_foldline_vh" onchange="preview.foldline('{$dvs}');">
                        <option value="V">세로</option>
                        <option value="H">가로</option>
                    </select>
                </dd>
                <dd class="br _col2">
                    <label>첫번째 선 <input type="text" class="mm" id="{$dvs}_foldline_info" name="{$dvs}_foldline_info" readonly="readonly" onblur="getAfterPrice.common('foldline', '{$dvs}');">mm</label>
                </dd>
                <input type="hidden" id="{$dvs}_foldline_price" name="{$dvs}_foldline_price" value="" />
            </dl>
        </div>
html;
    ...
    $html = <<<html
        <div class="option _embossing">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_embossing_dvs" onchange="loadEmbossingDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
                    <select id="{$dvs}_embossing_val" name="{$dvs}_embossing_val">
                        $depth2_option
                    </select>
                    <input type="hidden" id="{$dvs}_embossing_info" name="{$dvs}_embossing_info" value="" />
                    <input type="hidden" id="{$dvs}_embossing_price" name="{$dvs}_embossing_price" value="" />
                </dd>
                <dd class="br">
                    <label>가로 <input id="{$dvs}_embossing_wid_1" type="text" class="mm" onblur="getAfterPrice.common('embossing', '{$dvs}');">mm</label>
                    <label>세로 <input id="{$dvs}_embossing_vert_1" type="text" class="mm" onblur="getAfterPrice.common('embossing', '{$dvs}');">mm</label>
                </dd>
                <dd class="br note">
    ...
    $html = <<<html
        <div class="option _foil">
            <dl>
                <dt>박</dt>
                <dd>
                    <select id="{$dvs}_foil_1" style="width:85px;" class="_color" onchange="foilAreaInit('{$dvs}', this.value, '1');">
                        <option value="">-</option>
                        $opt1
                    </select>
                ...
                <dd class="br note" style="float:left; width:43%;">
                    File에 박 부분을 먹1도로 업로드 해주세요.
                </dd>
                <dd id="{$dvs}_foil_price_dd" class="price" style="position:relative; text-align:right; width:36%;"></dd>
            </dl>
        </div>
html;
    ...
    $html = <<<html
        <div class="option _thomson">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_thomson_dvs" onchange="loadThomsonDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
                    ...
                    <input type="hidden" id="{$dvs}_thomson_info" name="{$dvs}_thomson_info" value="" />
                </dd>
                <dd class="br">
                    <label>가로 <input id="{$dvs}_thomson_wid" type="text" class="mm" onblur="getAfterPrice.common('thomson', '{$dvs}');">mm</label>
                    <label>세로 <input id="{$dvs}_thomson_vert" type="text" class="mm" onblur="getAfterPrice.common('thomson', '{$dvs}');">mm</label>
                </dd>
            </dl>
        </div>
html;
    ...
    $html = <<<html
        <div class="option _numbering">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_numbering_dvs" onchange="loadDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
...
function getCuttingInfoHtml($info, $dvs) {
    ...
    for ($i = 0; $i < $info_count; $i++) {
        ...
        $option .= option($temp["mpcode"], $temp["depth1"], $attr);
    }
        ...
        <div class="option _cutting">
            <dl>
                ...
                <dd>
                    ...
                    <input type="hidden" id="{$dvs}_cutting_info" name="{$dvs}_cutting_info" value="" />
                </dd>
                <dd class="br">
                    <label>가로 <input type="text" class="mm" id="{$dvs}_cutting_wid"></label>
                    <label>세로 <input type="text" class="mm" id="{$dvs}_cutting_vert"></label>
                    <label><input type="text" class="mm"  id="{$dvs}_cutting_div"> 등분</label>
                </dd>
            </dl>
        </div>
html;
...
function getBindingInfoHtml($info, $dvs) {
    ...
    for ($i = 0; $i < $info_count; $i++) {
        ...
        $merge_arr[$depth1][$depth2] = $depth2;
    }
    ...
    foreach ($merge_arr as $depth1 => $depth2_arr) {
        ...
        if ($flag === true) {
            ...
            foreach ($depth2_arr as $depth2) {
                $depth2_option .= option($depth2, $depth2, "name=\"true\"");
            }
    ...
    $html = <<<html
        <div class="option _binding">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_binding_dvs" onchange="loadBindingDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
                    <select id="{$dvs}_binding_val" name="{$dvs}_binding_val" onchange="getAfterPrice.common('binding', '{$dvs}');">
                        $depth2_option
                    </select>
                </dd>
 ...
 * @return div html
 */
function getBondingInfoHtml($info, $dvs) {
    $info_count = count($info);
        ...
        <div class="option _bonding">
            <dl>
                ...
                <dd>
                    ...
                    <select id="{$dvs}_bonding_val" name="{$dvs}_bonding_val" onchange="getAfterPrice.common('bonding', '{$dvs}');">
                        $depth2_option
                    </select>
                </dd>
...
function getLaminexInfoHtml($info, $dvs) {
    $option = option($info[0]["mpcode"], "라미넥스");
    ...
    $html = <<<html
        <div class="option _laminex">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_laminex_val" name="{$dvs}_laminex_val">
                        $option
                    </select>
                    <label><input type="text" id="{$dvs}_laminex_info" name="{$dvs}_laminex_info" onblur="getAfterPrice.common('laminex', '{$dvs}');" class="page" value="10"> 매</label>
    ...
    $html = <<<html
        <div class="option _manufacture">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_manufacture_dvs" name="{$dvs}_manufacture_dvs" onchange="loadManufactureDepth2(this.value, '{$dvs}');">
                        $depth1_option
                    </select>
                    <select id="{$dvs}_manufacture_val" name="{$dvs}_manufacture_val" onchange="getAfterPrice.common('manufacture', '{$dvs}');">
                        $depth2_option
                    </select>
                    <p class="note">끈작업은 최대 40,000장 까지 가능합니다.</p>
                </dd>
    ...
    $html = <<<html
        <div class="option _lotterysilk">
            <dl>
                ...
                <dd>
                    <select id="{$dvs}_lotterysilk_val" name="{$dvs}_lotterysilk_val" onchange="getAfterPrice.common('lotterysilk', '{$dvs}');">
                        $option
                    </select>
                </dd>
                <dd>
