 ...
 * 2016/09/20 엄준현 수정(확장자에 따른 운영체제 반환값 추가)
 * =============================================================================
 */
...
// Settings
    ...
    $upload_path = SITE_DEFAULT_ORDER_FILE;
...
// Process the file
	...
	*/
    ...
    $seqno_arr = explode('|', $_GET["seqno"]);
    $count_seqno_arr = count($seqno_arr);;
	...
	showResult(true, $file_seqno, $oper_sys, "upload completed");

	exit(0);

function showResult($success, $file_seqno, $oper_sys, $message)
{
