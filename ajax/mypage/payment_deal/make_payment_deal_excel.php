...
$sheet->setCellValue("B14", $total_sell_price); // 총매출액
$sheet->setCellValue("F14", $total_sale_price); // 에누리
$sheet->setCellValue("I14", $total_pay_price); // 순매출액
...
while(1) {
    ...
    $summary = sprintf($summary_str, number_format($sell_price)
    ...
    $sheet->setCellValue('L' . $row_pos, "공급가액");
