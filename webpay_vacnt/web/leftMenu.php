...
<tr>
	...
	<tr>
		<td height="50" align="center" class="menuTitle">EASYPAY8.0</td>
	</tr>
	<tr>
...
<tr>
	<td height="25" onClick="clickshow(1)" style="cursor:hand;">&nbsp;<img src="./img/go_menu_open.gif" border="0">&nbsp;<b>무통장입금</b></td>
</tr>
<tr>
	<td bgcolor="#FFFFFF">
	<span id="block1" style="DISPLAY:none; MARGIN-LEFT:0px; CURSOR:hand">
		...
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('vacnt/vacnt.php');">계좌채번</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
...
<td height="25" onClick="clickshow(2)" style="cursor:hand;">&nbsp;<img src="./img/go_menu_open.gif" border="0">&nbsp;<b>취소</b></td>
</tr>
<tr>
    <td bgcolor="#FFFFFF">
    <span id="block2" style="DISPLAY:none; MARGIN-LEFT:0px; CURSOR:hand">
		...
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('mgr/mgr.php');">일반취소</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
