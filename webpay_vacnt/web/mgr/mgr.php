...
<script type="text/javascript">
    ...
    function f_submit() {
        ...
        if ( frm_mgr.mgr_txtype.value == "31" || frm_mgr.mgr_txtype.value == "60" ) {
            ...
            if ( frm_mgr.mgr_txtype.value == "31" ) {
                ...
                if ( !frm_mgr.mgr_socno.value ) {
                    alert("예금주 주민번호를 입력하세요!!");
                    frm_mgr.mgr_socno.focus();
                    return;
                }

                if ( !frm_mgr.mgr_telno.value ) {
                    alert("연락처를 입력하세요!!");
                    frm_mgr.mgr_telno.focus();
                    return;
                }
            }
        }
...
<input type = "hidden" name = "EP_mall_id" value = "T5102001">
