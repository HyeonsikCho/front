...
var modiMemberDetailInfo = function() {
    ...
    msg[0] = "개인 가입정보 생년월일을 입력 혹은 선택해주세요.";
    msg[1] = "개인 가입정보 생년월일을 입력 혹은 선택해주세요.";
    msg[2] = "개인 가입정보 생년월일을 입력 혹은 선택해주세요.";
    msg[3] = "개인 가입정보 이메일을 입력해주세요.";
    msg[4] = "개인 가입정보 이메일을 입력해주세요.";
    msg[5] = "개인 가입정보 전화번호를 입력해주세요.";
    msg[6] = "개인 가입정보 전화번호를 입력해주세요.";
    msg[7] = "개인 가입정보 전화번호를 입력해주세요.";
    msg[8] = "개인 가입정보 휴대전화를 입력해주세요.";
    msg[9] = "개인 가입정보 휴대전화를 입력해주세요.";
    msg[10] = "개인 가입정보 휴대전화를 입력해주세요.";
    msg[11] = "개인 가입정보 우편번호를 입력해주세요.";
    msg[12] = "개인 가입정보 주소를 입력해주세요.";
    msg[13] = "개인 가입정보 주소상세를 입력해주세요.";
    ...
    if ($("#member_dvs").val() == "기업 회원") {
        ...
        arr[17] = "co_zipcode";
        arr[18] = "co_addr";
        arr[19] = "co_addr_detail";
        //arr[17] = "co_tel_num1";
        //arr[18] = "co_tel_num2";
        //arr[19] = "co_tel_num3";

    	msg[14] = "사업자 등록정보 대표자를 입력해주세요.";
    	msg[15] = "사업자 등록정보 업태를 입력해주세요.";
    	msg[16] = "사업자 등록정보 업종을 입력해주세요.";
    	msg[17] = "사업자 등록정보 우편번호를 입력해주세요.";
    	msg[18] = "사업자 등록정보 주소를 입력해주세요.";
    	msg[19] = "사업자 등록정보 주소상세를 입력해주세요.";
    	//msg[17] = "사업자 등록정보 전화번호를 입력해주세요.";
    	//msg[18] = "사업자 등록정보 전화번호를 입력해주세요.";
    	//msg[19] = "사업자 등록정보 전화번호를 입력해주세요.";
    }
    ...
    data.mailing_yn = $(':radio[name="mailing_yn"]:checked').val();
    data.sms_yn = $(':radio[name="sms_yn"]:checked').val();
    ...
    data.co_tel_num = $("#co_tel_num1").val() + "-" + 
        ...
        $("#co_tel_num3").val();
	*/
    data.co_zipcode = $("#co_zipcode").val();
    data.co_addr = $("#co_addr").val();
    data.co_addr_detail = $("#co_addr_detail").val();
...
var getOrderMng = function() {
    ...
    var url = "/ajax/mypage/member_modify/load_order_mng_list.php";
    var callback = function(result) {
...
var regiOrderMng = function() {
    ...
    arr[9] = "pop_cel_num2";
    arr[10] = "pop_cel_num3";
    arr[11] = "pop_email_addr";
    arr[12] = "pop_email_domain";

    msg[0] = "회원명을 입력해주세요.";
    msg[1] = "직급을 입력해주세요.";
    msg[2] = "아이디를 입력해주세요.";
    msg[3] = "비밀번호를 입력해주세요.";
    msg[4] = "비밀번호 확인을 입력해주세요.";
    msg[5] = "전화번호를 입력해주세요.";
    msg[6] = "전화번호를 입력해주세요.";
    msg[7] = "전화번호를 입력해주세요.";
    msg[8] = "휴대전화를 입력해주세요.";
...
var getAccMng = function() {
    ...
    var url = "/ajax/mypage/member_modify/load_acc_mng_list.php";
    var callback = function(result) {
