...
class SheetCutInfoNCR extends CommonInfo {
    ...
    function init() {
        ...
        if ($sortcode_b === "006001003") {
            ...
            $template->reg($prefix . "mid1_paper", $mid_paper["info"]); 
            $template->reg($prefix . "mid2_paper", $mid_paper["info"]); 
            $mid_paper_mpcode = $temp["paper_mpcode"];
        ...
        $temp["cate_paper_mpcode"]  = $top_paper_mpcode;
        ...
        //######################### 중지
        if ($sortcode_b === "006001002" || $sortcode_b === "006001003") {
